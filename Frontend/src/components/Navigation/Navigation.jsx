            ...
            <div>
                <div className={toggles}>
                    ...
                    <li>
                      ...
                      <li>
                            <Link to="/student" style={path == "/student" ? { color: getColor() } : { color: getColor2() }}>
                                <p className="hovertext" data-hover="Student"><FaUsers size="1.7rem" ></FaUsers></p>
                            </Link>                      
                        </li>
                      <li>
                            <Link to="/teacher" style={path == "/teacher" ? { color: getColor() } : { color: getColor2() }}>
                                <p className="hovertext" data-hover="Teacher"><ImUserTie size="1.7rem" ></ImUserTie></p>
                            </Link>                      
                        </li>
                    </ul>
                </div>
